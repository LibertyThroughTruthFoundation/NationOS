...
**Gregorian Date:** Thursday, January 29, 2026
**Hebrew Date:** 11 Shevat 5786

### 1. Introduction

This document defines the Sovereign Time Protocol, a standard for dual Gregorian and Biblical timestamping to be used in all NationOS and Household OS documentation. The purpose of this protocol is to anchor all project activities in both the secular and biblical calendars, acknowledging God's sovereignty over time.

### 2. Protocol Specification

#### 2.1. Timestamp Format

All documents must include a dual timestamp at the beginning of the document, in the following format:

**Gregorian Date:** [Day of the week], [Month] [Day], [Year]
...
#### 2.2. Biblical Calendar Source

The primary source for converting Gregorian dates to Hebrew dates will be Hebcal.com. Chabad.org may be used as a secondary source for verification.

### 3. Implementation

This protocol will be implemented in all new documents created for the NationOS project. Existing documents will be updated with the dual timestamp as they are revised.

### 4. Rationale

The implementation of the Sovereign Time Protocol is a declaration of our commitment to acknowledging God's sovereignty over all aspects of our lives, including our work on the NationOS project. By anchoring our documentation in both the secular and biblical calendars, we are reminded that our time is not our own, but belongs to Him.
